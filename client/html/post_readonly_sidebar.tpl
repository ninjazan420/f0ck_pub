<div class='readonly-sidebar'>
    <article class='details'>
        ...
        <section class='social'>
            ...
            <div class='fav-container'></div><br>
        </section>
        ...
        <section class='search'>
            Search on
            <a target="_blank" href='https://lens.google.com/uploadbyurl?url=<%- encodeURIComponent(ctx.post.fullContentUrl) %>'>Google Lens</a> &middot;
            <a target="_blank" href='https://gelbooru.com/index.php?page=post&s=list&tags=md5:<%- ctx.post.checksumMD5 %>'>Gelbooru</a> &middot;
            <a target="_blank" href='http://iqdb.org/?url=<%- encodeURIComponent(ctx.post.fullContentUrl) %>'>IQDB</a> &middot;
            <a target="_blank" href='https://danbooru.donmai.us/posts?tags=md5:<%- ctx.post.checksumMD5 %>'>Danbooru</a>
        </section>
