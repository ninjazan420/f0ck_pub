...
class PostMainController extends BasePostController {
    ...
    _evtFeaturePost(e) {
        ...
        e.detail.post.feature().then(
            () => {
                this._view.sidebarControl.showSuccess("Beitrag gefeatured.");
    ...
    _evtDeletePost(e) {
        ...
        e.detail.post.delete().then(
            () => {
                ...
                ctx.controller.showSuccess("Beitrag gelöscht.");
            },
            (error) => {
                this._view.sidebarControl.showError(error.message);
                this._view.sidebarControl.enableForm();
    ...
    _evtUpdatePost(e) {
        ...
        post.save().then(
            () => {
                this._view.sidebarControl.showSuccess("Beitrag gespeichert.");
                this._view.sidebarControl.enableForm();
                misc.disableExitConfirmation();
            },
            (error) => {
