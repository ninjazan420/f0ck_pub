...
class UserController {
    ...
    _evtUpdate(e) {
        ...
        e.detail.user
            ...
            .then(
                () => {
                    this._view.showSuccess("Einstellungen gespeichert.");
        ...
        e.detail.user.delete().then(
            () => {
                ...
                if (api.hasPrivilege("users:list")) {
                    ...
                    ctx.controller.showSuccess("Account gelöscht.");
                } else {
        ...
        if (api.isCurrentAuthToken(e.detail.userToken)) {
            ...
            e.detail.userToken.delete(e.detail.user.name).then(
                () => {
                    ...
                    ctx.controller.showSuccess(
                        "Token " + e.detail.userToken.token + " gelöscht."
                    );
                },
                (error) => {
                    this._view.showError(error.message);
    ...
    _evtUpdateToken(e) {
        ...
        e.detail.userToken.save(e.detail.user.name).then(
            (response) => {
                ...
                ctx.controller.showSuccess(
                    "Token " + response.token + " aktuallisiert."
                );
            },
            (error) => {
                this._view.showError(error.message);
