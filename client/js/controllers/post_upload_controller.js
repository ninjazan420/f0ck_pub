...
const genericErrorMessage =
    "Ein oder mehrere Posts brauchen deine Aufmerksamkeit; " +
    'Klicke "weiter", wenn alles bereit ist.';
...
class PostUploadController {
    constructor() {
        ...
        if (!api.hasPrivilege("posts:create")) {
            ...
            this._view.showError("Du hast nicht die benötigten Berechtigungen.");
            return;
        }
        ...
        e.detail.uploadables
            ...
            .then(
                () => {
                    ...
                    ctx.controller.showSuccess("Erfolgreich hochgeladen.");
                },
                (error) => {
                ...
                if (searchResult) {
                    ...
                    if (searchResult.exactPost) {
                        if (skipDuplicates) {
                            ...
                            let error = new Error(
                                "Post wurde bereits hochgeladen " +
                    ...
                    if (
                        ...
                        let error = new Error(
                            `Found ${searchResult.similarPosts.length} similar ` +
                                "posts.\nDu kannst entweder fortsetzen, oder den Upload abbrechen."
                        );
                        error.uploadable = uploadable;
